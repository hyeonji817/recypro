...
<body>
	...
	<div class="title">
		<div class="container_title">
			<h1 class="display-3" style="font-weight: bold; text-shadow: 1px 1px 5px #bdbdbd;">고객센터 - 공지사항_작성하기</h1>
		</div>
	</div>
		...
		<div class="row" id="write" style="width: 800px; margin: 0 auto; position: relative;">
			<form method="post" action="notice_Action.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; width: 800px; text-align: center;">공지글 글쓰기 양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>
								<input type="text" class="form-control" placeholder="글 제목" name="notice_title" maxlength="50"  style="width:800px">
							</td>
						</tr>
						<tr>
							<td>
								<textarea class="form-control" placeholder="글 내용" name="notice_content" maxlength="2048" style="height: 500px; width:800px;"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
