				...
				<table class="table" style="border: 1px solid #dddddd">
					<tbody>
						<tr>
							<td>
<!-- 								제목 -->
								<input type="text" class="form-control" placeholder="구매확정이 뭐예요?" name="question_title" maxlength="50" style="width: 500px;">
							</td>
						</tr>
						<tr>
							<td>
								...
								[구매확정]이란, 고객님의 반품(교환) 의사가 없을 경우 <br>
								해당 주문 건의 거래를 완료하는 것입니다. <br><br>
								
								클릭하시면 교환, 반품은 하실 수 없으니, 배송완료 후 <br>
								7일 이내에 버튼을 클릭하시면 됩니다. <br><br> 
								
								★구매확정 이후 반품/교환 처리가 안 되니 주의하시기 바랍니다.<br>
							</td>
						</tr>
					</tbody>
				</table>
