...
<head>
<meta charset="UTF-8">
<title>재활용품 전문점 : 리싸이프로 - 고객센터_공지사항 답변1</title>
				...
				<table class="table" style="border: 1px solid #dddddd">
					<tbody>
						<tr>
							<td>
<!-- 								제목 -->
								<input type="text" class="form-control" placeholder="회원탈퇴 후 보유 쿠폰은 어떻게 되나요?" name="question_title" maxlength="50" style="width: 500px;">
							</td>
						</tr>
						<tr>
							<td>
								...
								리싸이프로 홈페이지 탈퇴 시, 쿠폰은 자동 소멸되며, 재가입시에도 복구가 되지 않습니다. <br>
								탈퇴 신청 시 신중히 결정해 주시기 바랍니다.
							</td>
						</tr>
					</tbody>
				</table>
