				...
				<table class="table" style="border: 1px solid #dddddd">
					<tbody>
						<tr>
							<td>
<!-- 								제목 -->
								<input type="text" class="form-control" placeholder="반품/교환 신청을 했는데 처리 소요시간이 얼마나 되나요?" name="question_title" maxlength="50" style="width: 500px;">
							</td>
						</tr>
						<tr>
							<td>
								...
								반송해주신 상품이 리싸이프로 물류센터로 도착한 뒤 2~3일 이내에 <br>
								고객님께 교환상품이 재발송, 환불처리가 되고 있습니다. <br>
								최대 소요시간은 5일이 소요된다고 생각하시면 감사하겠습니다. <br>
							</td>
						</tr>
					</tbody>
				</table>
