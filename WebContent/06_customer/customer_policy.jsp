...
<title>재활용품 전문점 : 리싸이프로 - 고객센터_운영정책</title>
<style>
.title {
	margin-top: 11%;
	height: 150px;
...
<body>
	...
	<div class="third_policy">
		...
		<p>
			...
			지 공지합니다.다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 "몰"은 개 
	...
	<div class="policy_button">
		<a href="customer_main.jsp" class="btn btn-default btn-lg" style="background-color: #b6f5f5;">고객센터 홈</a>
	</div>
</body>
</html>