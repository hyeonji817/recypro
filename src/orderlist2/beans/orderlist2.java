...
public class orderlist2 {
	...
	private String shopping_img;		// 첨부사진 
	...
	public String toString() {
		return "orderlist2 [shopping_userId=" + shopping_userId + ", shopping_productId=" + shopping_productId
				...
				+ shopping_addressName + ", shopping_num=" + shopping_num + ", shopping_img=" + shopping_img + "]";
	}
}
